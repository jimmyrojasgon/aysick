...
try {
    ...
    $mail->Username   = 'jimmyrojasgonzales@gmail.com';               //SMTP username
    $mail->Password   = '********';                            //SMTP password
    $mail->SMTPSecure = 'tls';                                  //Enable implicit TLS encryption
    $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('jimmyrojasgonzales@gmail.com', 'jimmyl');         // Origen   
    $mail->addAddress($email);          					    //Add a recipient (Destino) Pre-Requisito que el correo gmail EXISTA
  
  
    //Content
    $mail->isHTML(true);                                  //Set email format to HTML
    $mail->Subject = 'Sistema Aysick';
